...
public class CodeGenerator {
  ...
  public void generate() throws Exception {
    ClassFile f = new ClassFile("Test", AccessFlag.PUBLIC, AccessFlag.SUPER, AccessFlag.SYNTHETIC);
    ...
    cpb
      ...
      .thisClass("Test") // TODO should be inferred from the class file name
    ...
    // generate method
    CodeAttributeBuilder init = mpb.beginMethod()
    ...
    CodeAttributeBuilder main = mpb.beginMethod()
